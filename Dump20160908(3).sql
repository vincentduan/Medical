...
INSERT INTO `article` VALUES (1,2,'doc2','title1','wenzhangneirong1',1,2,'0','sdfs','摘要1',NULL,NULL,0),(2,2,'doc2','title2','<p>这里写你的内容2<img alt=\"mountietocat.png\" src=\"/Medical/resources/image/20160826/1472200068847013663.png\" title=\"1472200068847013663.png\"/></p>',1,2,'0',NULL,'摘要2','2016-08-26 08:27:54',NULL,0),(3,2,'doc2','title3','<p><img alt=\"Chrysanthemum.jpg\" src=\"/Medical/resources/image/20160826/1472201381782094370.jpg\" title=\"1472201381782094370.jpg\"/>哈哈</p>',1,3,'0',NULL,'摘要3','2016-08-26 08:49:52',NULL,0);
...
CREATE TABLE `user_collection_article` (
  ...
  `isDel` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='用户收藏文章';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_collection_article` VALUES (1,1,1,NULL,NULL,NULL,NULL,NULL,0),(2,1,2,NULL,NULL,NULL,NULL,NULL,0);
/*!40000 ALTER TABLE `user_collection_article` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `user_rel_article`
--

DROP TABLE IF EXISTS `user_rel_article`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `user_rel_article` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `userid` int(11) DEFAULT NULL,
  `article_id` int(11) DEFAULT NULL,
  ...
  `isDel` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='用户浏览过的文章记录';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `user_rel_article`
--

LOCK TABLES `user_rel_article` WRITE;
/*!40000 ALTER TABLE `user_rel_article` DISABLE KEYS */;
INSERT INTO `user_rel_article` VALUES (1,1,1,NULL,NULL,NULL,0),(2,1,2,NULL,NULL,NULL,0),(3,2,1,NULL,NULL,NULL,0);
/*!40000 ALTER TABLE `user_rel_article` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2016-09-08 18:32:36
