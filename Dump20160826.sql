...
CREATE TABLE `article` (
  ...
  `category` varchar(255) DEFAULT NULL COMMENT '文章所属科室分类',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='医生上传文章';
...
INSERT INTO `article` VALUES (1,2,'asdfasdf','sdfsdfsd','啊啊','0','sdfs',NULL,NULL,NULL,0);
...
-- Dump completed on 2016-08-26 12:55:12
