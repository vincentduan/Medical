...
CREATE TABLE `user_rel_article` (
  ...
  `isDel` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='用户浏览过的文章记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_rel_article` VALUES (1,1,1,NULL,NULL,NULL,0);
...
-- Dump completed on 2016-09-07  0:11:13
